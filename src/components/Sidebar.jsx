...
function Sidebar() {
    return (
        ...
        <ul class="list list-stack">
          <NavLink to="/home">
          <li class="list-item link flex-row-center">
              ...
              <span class="margin-l-2">Home</span>
          </li>
          </NavLink>
          ...
          <li class="list-item link flex-row-center">
              ...
              <span class="margin-l-2">Watchlater</span>
          </li>
          </NavLink>
          <NavLink to="liked">
          <li class="list-item link flex-row-center">
              ...
              <span class="margin-l-2">Liked Videos</span>
          </li>
          </NavLink>
          <NavLink to="playlist">
          <li class="list-item link flex-row-center">
              ...
              <span class="margin-l-2">Playlist</span>
          </li>
          </NavLink>
          <NavLink to="history">
          <li class="list-item link flex-row-center">
              ...
              <span class="margin-l-2">History</span>
          </li>
          </NavLink>
        </ul>
      </aside>
