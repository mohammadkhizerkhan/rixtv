...
function SingleVideo() {
    ...
    const {_id,title,views,desc,channelName,channelImg,channelLink,likes,uploaded} =video;
    console.log(video)
    ...
    return (
      ...
      <section class="single-video-details">
        ...
        <div class="single-video-btns flex-row-center">
          <button class="btn btn-s flex-row-center single-video-btn" onClick={()=>navigate(-1)}>
          ...
          <button class="btn btn-s flex-row-center single-video-btn">
            <svg width="2rem" height="2rem" viewBox="0 0 24 24"><path fill="#d6d6d6" d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41L9 16.17z"></path></svg>
            <span class="margin-l-1 white-color font-2"
              >Watchlater</span
            >
          </button>
          <button class="btn btn-s flex-row-center single-video-btn">
        ...
        <div class="channel-div flex-row-center">
            ...
            <img src={channelImg} alt="" class="img-responsive video-channel-avatar"/>
            {/* </Link> */}
